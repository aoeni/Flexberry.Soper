...
namespace IIS.Soper
{
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Soper.МестоНаРейс fМестоНаРейс;
        
        private IIS.Soper.КодБрони fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Soper.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Soper.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Soper.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Soper.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Soper.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Soper.Пассажир));
                }
            }
        }
    }
