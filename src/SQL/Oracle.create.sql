...
ALTER TABLE "Проверка"
	ADD CONSTRAINT "Проверка_FОпе_6679" FOREIGN KEY ("Опертор") REFERENCES "Опертор" ("primaryKey");

CREATE INDEX "Проверка_IОпе_4076" on "Проверка" ("Опертор");
