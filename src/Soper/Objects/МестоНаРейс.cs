...
namespace IIS.Soper
{
    ...
    public class МестоНаРейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Soper.КлассБилета fКласс;
        ...
        public virtual IIS.Soper.КлассБилета Класс
        {
            get
            {
                ...
                IIS.Soper.КлассБилета result = this.fКласс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсE", typeof(IIS.Soper.МестоНаРейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсL", typeof(IIS.Soper.МестоНаРейс));
                }
            }
        }
    }
